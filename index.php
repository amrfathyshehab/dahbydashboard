<?php
 ...
 try
 {
      ...
      if(isset($_POST["login"]))
      {
           ...
           {
				$message = '<label style="color:blue">All fields are required</label>';
...
<head>
	...
	<meta charset="UTF-8">
	<link rel="icon" href="php/assets/images/avatars/dahbii-photo.png">
...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url(assets/img/cover.png);background-position: right;
  background-repeat: no-repeat;
  background-size: cover;  height: 100%;
">
			<div class="wrap-login100">
				<div class="login100-form-title" style="background-image: url(login-ui/images/back.jpg);">
